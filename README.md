...
* pywb ([src](https://github.com/webrecorder/pywb) ⭐ 1,700 | 🐛 194 | 🌐 JavaScript | 📅 2026-09-21) - Python-based replay engine.
...
* Comunica ([src](https://github.com/comunica/comunica) ⭐ 609 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-21) - A knowledge graph querying framework for JavaScript with [Memento support](https://github.com/comunica/comunica/pull/195) ⭐ 609 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-21.
